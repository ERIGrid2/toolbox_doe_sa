...
class CollectorSummerschool(mosaik_api.Simulator):
    def __init__(self):
        super().__init__(META)
        self.eid = None
    ...
    def init(self, sid, time_resolution, step_size, print_results=True, save_h5=True, h5_storename='collectorstore', h5_framename=None):
